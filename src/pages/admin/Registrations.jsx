 ...
 <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
      ...
      <Card className="mb-6">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Registration Overview</h3>
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              Manage all project registrations for the Tourism Project Showcase. Review submissions, approve or reject
              applications, and communicate with participants.
            </p>
          </div>
        </div>
      </Card>

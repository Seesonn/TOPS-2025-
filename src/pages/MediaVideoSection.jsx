              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                  <button
                    ...
                    className="w-16 h-16 rounded-full bg-blue-600 bg-opacity-90 flex items-center justify-center hover:bg-opacity-100 transition-all transform hover:scale-105"
        ...
        >
          <div className="relative max-w-5xl w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-black rounded-lg overflow-hidden">
              <VideoPlayer
                src={activeVideo.videoUrl || "https://example.com/video.mp4"}

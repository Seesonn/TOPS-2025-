...
const Checkout = () => {
  ...
  //     navigate("/login", { state: { from: "tickets", ticketId: ticketType } })
  //   } else if (storedEmail) {
  ...
  // useEffect(() => {
  //   if (userEmail) {
  //     // This will be used to pre-fill the checkout form
  //     // The CheckoutForm component will need to be updated to accept initialData
  //   }
  // }, [userEmail])
  ...
  const handlePayment = (paymentData) => {
    ...
    const allFormData = { ...formData, ...paymentData }
    ...
    setTimeout(() => {
      ...
      setOrderDetails({
        ...
        price: ticketDetails[ticketType]?.price,
        paymentMethod: paymentData.paymentMethod,
        email: allFormData.email || paymentData.email, // Use allFormData here, not completeFormData
        // Store first name and last name separately
              ...
              <Card className="p-6 md:p-8 shadow-lg">
                <div className="mb-8">
                  ...
                  {step === 1 ? (
                    <div className="animate-fade-in">
                      <h3 className="text-lg font-semibold mb-4">Personal Information</h3>
                      <CheckoutForm onNext={handleFormData} ticketType={ticketType} />
                    </div>
                  ) : (
                    <div className="animate-fade-in">
                      <h3 className="text-lg font-semibold mb-4">Payment Information</h3>

      ...
      const mockRegistrations = [
        {
          ...
          members: [
            { name: "Aarav Sharma", email: "aarav@example.com", institution: "Kathmandu University" },
            { name: "Priya Thapa", email: "priya@example.com", institution: "Kathmandu University" },
            { name: "Rohan Gurung", email: "rohan@example.com", institution: "Tribhuvan University" },
          ],
        ...
        },
        {
          ...
          leaderEmail: "anisha@example.com",
          leaderPhone: "+977 9802345678",
          leaderInstitution: "Nepal Engineering College",
          members: [
            { name: "Anisha Rai", email: "anisha@example.com", institution: "Nepal Engineering College" },
            { name: "Suraj Limbu", email: "suraj@example.com", institution: "Nepal Engineering College" },
            { name: "Dipika Shrestha", email: "dipika@example.com", institution: "Pokhara University" },
            { name: "Bikash Tamang", email: "bikash@example.com", institution: "Tribhuvan University" },
          ],
        ...
        },
        {
          ...
          leaderEmail: "rajesh@example.com",
          leaderPhone: "+977 9803456789",
          leaderInstitution: "Tribhuvan University",
          members: [
            { name: "Rajesh Magar", email: "rajesh@example.com", institution: "Tribhuvan University" },
            { name: "Sabina Khadka", email: "sabina@example.com", institution: "Tribhuvan University" },
          ],
          heardFrom: "newspaper",
        ...
        },
        {
          ...
          leaderEmail: "nischal@example.com",
          leaderPhone: "+977 9804567890",
          leaderInstitution: "Pokhara University",
          members: [
            { name: "Nischal Basnet", email: "nischal@example.com", institution: "Pokhara University" },
            { name: "Kriti Pradhan", email: "kriti@example.com", institution: "Pokhara University" },
            { name: "Aashish KC", email: "aashish@example.com", institution: "Pokhara University" },
          ],
          heardFrom: "friend",
          specialRequirements: "",
        ...
        },
        {
          ...
          leaderEmail: "suman@example.com",
          leaderPhone: "+977 9805678901",
          leaderInstitution: "Agriculture and Forestry University",
          members: [
            { name: "Suman Tamang", email: "suman@example.com", institution: "Agriculture and Forestry University" },
            { name: "Puja Rai", email: "puja@example.com", institution: "Agriculture and Forestry University" },
            { name: "Binod Sherpa", email: "binod@example.com", institution: "Agriculture and Forestry University" },
            { name: "Gita Magar", email: "gita@example.com", institution: "Tribhuvan University" },
          ],
          heardFrom: "university",

          ...
          <div className="mb-6 flex items-start bg-blue-50 p-4 rounded-lg">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Selected teams will receive expert mentorship and must conduct
                mandatory site visits to develop comprehensive projects.
              </p>
            </div>
          </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-[#F58432]">
                  ...
                  deliverables must be submitted by the specified deadline. Late
                  submissions may result in point deductions.
                </p>
              </div>
            </div>
          </div>
